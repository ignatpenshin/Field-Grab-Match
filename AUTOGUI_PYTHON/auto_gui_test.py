...
while True:
    time.sleep(2)
    if pyautogui.locateOnScreen("name.png", confidence=0.95) != None:
        print("I can see it")
        time.sleep(1)
        click(75, 140)
        time.sleep(1)
        ...
        while True:
            if pyautogui.locateOnScreen("file.png", confidence=0.9) != None:
                ...
                break
        while True:
            if pyautogui.locateOnScreen("export.png", confidence=0.8) != None:
                x, y = pyautogui.locateCenterOnScreen('export.png')
                time.sleep(1)
                click(x,y)
                break
        while True:
            if pyautogui.locateOnScreen("library.png", confidence=0.8) != None:
                x, y = pyautogui.locateCenterOnScreen('library.png')
                time.sleep(1)
                click(x,y)
                break
        while True:
            if pyautogui.locateOnScreen("docs.png", confidence=0.8) != None:
                ...
                break
        while True:
            if pyautogui.locateOnScreen("TRACKS.png", confidence=0.8) != None:
                ...
                break 
        while True:
            if pyautogui.locateOnScreen("GPS.png", confidence=0.8) != None:
                ...
                break
        while True:
            if pyautogui.locateOnScreen("exit.png", confidence=0.8) != None:
                ...
                break         
        while True:
            if pyautogui.locateOnScreen("NO.png", confidence=0.95) != None:
